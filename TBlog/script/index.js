...
const TB = (function () {
	...
	class WindowMessage {
		static ARTICLE( data ) {
			if ( data["height"] ) BasicElement["tb-app-content-article-view"].style.height = `${ data["height"] + 50 }px`;
			else BasicElement["tb-app-content-article-view"].classList.remove( "loading" );
		}
