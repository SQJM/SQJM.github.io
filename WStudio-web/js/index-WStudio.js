...
function ers(A, B, C, D) {
  ...
  var list_1 =
    '"><div class="memberData"><div><p style=" position: relative;left: 6px; "><button style="font-size: 1.5em;" onclick=""+D+"">';
  //名字
  var list_2 =
    '</button><hr style="line-height: 0.3em;position: relative;left: 6px;"></div><p style="font-size: 11px;position: relative;left: 6px;">';
  //介绍
  var list_3 =
    '</p></div><p class="break">-</p></div></div><p class="break">-</p><p class="break">-</p></div>';
