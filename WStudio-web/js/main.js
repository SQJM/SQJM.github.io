...
function home() {
  window.open("https://worldstudio.netlify.app/");
}
...
function setFooterBox(addqq, addDesktop, addThis) {
  ...
  function dl_friend() {
    ...
    dl_Friend.innerHTML +=
      '<dd><button onclick=" window.location.href = ' +
      WS_Web +
      ' ">WStudio</button></dd>';
  }
  ...
  function dl_help() {
    ...
    dl_Help.innerHTML +=
      '<dd><button onclick=" window.location.href =  ">使用条款</button></dd>';
    dl_Help.innerHTML +=
      '<dd><button onclick=" window.location.href =  ">关于我们</button></dd>';
  }
  ...
  function div_footerTagBox() {
    ...
    div_footerTagBox.innerHTML +=
      b +
      'onclick="goWS();">官网</button></span>' +
      g +
      b +
      'onclick="' +
      addqq +
...
function cout(title, text) {
  ...
  temp.innerHTML +=
    '<div id="cout" class="cout" style="width: 60%;max-width: 520px;"><p class="break">-</p><div id="coutM"><center><div class="coutT">' +
    title +
    '</div><p class="break">-</p><div class="coutE">' +
    text +
    '</div><p class="break">-</p><button id="coutBtn" onclick="closeCout();">确定</button></center></div><p class="break">-</p></div>';
  temp.innerHTML +=
    '<div id="coutBj" class="coutBj"><img id="coutIMG" src="img/coutBj.png"></div>';
